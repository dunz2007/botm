...
if(username !== undefined) {
  ...
  if(process.env.REPLIT_CLUSTER == 'hacker') logger('Bạn Đang Sử Dụng Replit Hacker, Hãy Nhớ Bật "Always On" Để BOT Luôn Chạy Nhé!', '[ KIỂM TRA HOST ]');
  logger('Bạn Đang Sử Dụng Replit Thường, Hệ Thống Sẽ Tự Động Kết Nối Với UptimeRobot Cho Bạn!', '[ KIỂM TRA HOST ]');
...
chalkAnimation.rainbow('Lê Bá Bách');
